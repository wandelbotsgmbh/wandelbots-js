...
var NovaCellAPIClient = class {
  ...
  deviceConfig = this.withCellId(DeviceConfigurationApi);
  motionGroup = this.withCellId(MotionGroupApi);
  motionGroupInfos = this.withCellId(MotionGroupInfosApi);
  controller = this.withCellId(ControllerApi);
  program = this.withCellId(ProgramApi);
  programValues = this.withCellId(ProgramValuesApi);
  controllerIOs = this.withCellId(ControllerIOsApi);
  motionGroupKinematic = this.withCellId(MotionGroupKinematicApi);
  motion = this.withCellId(MotionApi);
  coordinateSystems = this.withCellId(CoordinateSystemsApi);
  motionGroupJogging = this.withCellId(MotionGroupJoggingApi);
  virtualRobot = this.withCellId(VirtualRobotApi);
  virtualRobotSetup = this.withCellId(VirtualRobotSetupApi);
  virtualRobotMode = this.withCellId(VirtualRobotModeApi);
  virtualRobotBehavior = this.withCellId(VirtualRobotBehaviorApi);
  libraryProgramMetadata = this.withCellId(LibraryProgramMetadataApi);
  libraryProgram = this.withCellId(LibraryProgramApi);
  libraryRecipeMetadata = this.withCellId(LibraryRecipeMetadataApi);
  libraryRecipe = this.withCellId(LibraryRecipeApi);
};
